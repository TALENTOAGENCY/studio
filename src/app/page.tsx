import { Award, Briefcase, Building, Check, Clock, Code, DollarSign, ListChecks, MapPin, Network, Target, User, Users } from "lucide-react";
          ...
          <Card className="overflow-hidden shadow-lg">
            <CardContent className="p-6 md:p-8">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div>
                  <Badge variant="outline" className="mb-2">Onsite Work Marketplace</Badge>
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-2 text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1.5"><Building className="h-4 w-4" /> Engineering</div>
                  </div>
                </div>
